...
; -------- G.P.R Setup -----------------
    cblock      0x0C
        COUNT1          ; First counter
        COUNT2          ; Second counter
        BYTE            ; Byte storing the NES button status
        N_BIT           ; Used to count the bit readed
    endc
; ------- Port Setup ------------------
...
Loop1:
        ...
        movwf   COUNT1      
Loop2:
        decfsz  COUNT1,1    ;COUNT2--; if COUNT2=0 Skip next instruction
        goto    Loop2
